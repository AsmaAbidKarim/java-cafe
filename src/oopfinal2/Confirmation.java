...
public class Confirmation extends javax.swing.JFrame {
  public String details;
    ...
    public Confirmation() throws FileNotFoundException {
        initComponents();
        java.io.File file11=new java.io.File("confirm.txt");
        
         Scanner input=new Scanner(file11);
   ...
   input.close();
   //java.io.PrintWriter confirmation=new java.io.PrintWriter(new FileOutputStream("confirm.txt",false));
   //confirmation.print("");
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setForeground(new java.awt.Color(152, 24, 24));
        jLabel2.setText("Thankyou for Ordering");
